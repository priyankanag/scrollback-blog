...
function program6(depth0,data) {
  ...
  stack1 = (helper = helpers['ghost-popover'] || (depth0 && depth0['ghost-popover']),options={hash:{
    'open': ("showMenu")
  },hashTypes:{'open': "ID"},hashContexts:{'open': depth0},inverse:self.noop,fn:self.program(5, program5, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "ghost-popover", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n            </li>\n        </ul>\n    </nav>\n</header>\n");
  return buffer;
